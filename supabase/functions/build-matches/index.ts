  ...
  try {
    ...
    for (const apiEntry of rawApis) {
      ...
      const processed = games.map((g: any) => {
        ...
        // Buscar IDs internos o usar API como respaldo
        ...
        return {
          ...
          match_time_utc: new Date(g.startTime).toLocaleTimeString('es-AR', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false }),
